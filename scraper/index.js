...
async function run() {
  ...
  for (const [code, data] of Object.entries(results)) {
    ...
    // Bản gọn cho biểu đồ: /history/{ngoại tệ}/{ngày}/{mã NH} = {tm, ck, b}.
    // Tách theo ngoại tệ để khi vẽ biểu đồ chỉ tải đúng loại đang xem, thay vì
    // kéo cả kho dữ liệu về máy.
